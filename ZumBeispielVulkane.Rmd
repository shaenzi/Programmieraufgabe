...
Eine weitere mögliche Überlegung sind die Leute, die in der nähe von aktiven und explosiven Vulkanen leben. Daher schaue ich mir an, wieviele Leute in der Nähe von Vulkanen leben, die in den letzten 50 Jahren mit einem Explosivitäts-Index von mindestens 2 ausgebrochen sind.
...
Todo: add something to the color aesthetic
...
select last 50y only

top 4 regions regarding highest VEI
```{r}
